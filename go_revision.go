...
type GoRevisionStackProps struct {
	awscdk.StackProps
}

func NewGoRevisionStack(scope constructs.Construct, id string, props *GoRevisionStackProps) awscdk.Stack {
	...
	// example resource
	// queue := awssqs.NewQueue(stack, jsii.String("GoRevisionQueue"), &awssqs.QueueProps{
...
func main() {
	...
	NewGoRevisionStack(app, "GoRevisionStack", &GoRevisionStackProps{
		awscdk.StackProps{
			Env: env(),
		},
	})
